...
class OneDoWhileAndOneIfElseTest(leftchangedlines: Array[Int] , rightchangedlines: Array[Int]) extends JSVFATest {
    override def getClassName(): String = "samples.OneDoWhileAndOneIfElse"
