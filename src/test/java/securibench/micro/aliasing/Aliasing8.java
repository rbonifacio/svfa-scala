...
/** 
 *  @servlet description="aliasing in an array index"
 *  @servlet vuln_count = "1"
 *  */
public class Aliasing8 extends BasicTestCase implements MicroTestCase {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
       ...
       sink(names);                                     /* This should be consider a leak too, because one array element is tainted */
    }
    
    public String getDescription() {
        return "aliasing in an array index";
    }
