 ...
 *  */
public class Basic17v4 extends BasicTestCase implements MicroTestCase {
    public class Widget {
        String contents;
    ...
    protected void sink(HttpServletResponse resp, Widget w) throws IOException {
        PrintWriter writer = resp.getWriter();
        writer.println(w.contents);
    }
